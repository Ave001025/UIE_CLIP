...
model = dict(
    ...
    generator=dict(
        ...
        classnames=[
            ...
            #['Color undistorted,Clear,high contrast underwater photo','Color distorted,unclear,low contrast underwater photo'],
            #['Color undistorted underwater photo','Color distorted underwater photo'],
            #['Clean underwater photo','Unclean underwater photo'],
            #['High quality unerwater photo.','low quality underwater photo.'],
            #['Clean underwater photo.', 'Unclean underwater photo.'],
            #['High contrast underwater photo.','Low contrast underwater photo.'],
            #['Clear underwater photo.','Unclear underwater photo.'],
            ['Clear underwater photo.','Turbid underwater photo.'],
            #['Good underwater photo.','Bad underwater photo.'],
